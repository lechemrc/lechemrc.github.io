---
layout: post
title: <p style="color:orange">Something Personal</p>
image: /img/student_computer.jpg
...
What if you had a worksheet that gave you back deep analytical data on the students? Nothing like this existed. The reason worksheets are what came to mind first is because <a href="https://www.scientificamerican.com/article/why-writing-by-hand-is-better-for-memory-and-learning/">handwriting leads to better memory retention for students.</a> Programs that showed videos or had you type answers still didn't show a student's thought process for teachers nor did it stick as well. This was the key. 

Over the years since I've had that thought, I've tried building it several times and it got very complex very fast. That, and the data science and machine learning just didn't quite have the capabilities I wanted without significant resources necessary to build it. Fast forward to now and I've been able to utilize strictly guided agentic AI (I'm currently using Kiro) to very carefully spec out what the requirements and pieces for this build are, what will need to be done, and how it should be built, all while utilizing my knowledge in coding and machine learning. This has given me a significant edge in developing the Math-o-matic software, as I'm calling it. 
